...
REST API для мобильного приложения "Библиотека книг". Реализованы:

- Регистрация / Авторизация (JWT)
- CRUD операций с книгами
- Доступ к библиотеке других пользователей
- Восстановление удалённых книг

## Code Style

Код отформатирован с помощью [PHP-CS-Fixer]
